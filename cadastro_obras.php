...
if(isset($_POST['done'])){   
    ...
    if(empty($nome)){
       ...
       $sql = mysql_query("INSERT INTO `crtl_patrimonio_obras`(`data_criacao`,`ip`,`nome`,`color`,`usuario_cadastro`) VALUES (now(),'$ip_criacao','$nome ','$color','$usuario_cadastro')") or die(mysql_error());
...
<br><center>
  <h1 class="title has-text-grey">CADASTRO DE STATUS</h1>
    ...
    <section class="hero is-success is-fullheight">
            ...
            <div class="container has-text-centered">			
                <div class="column is-4 is-offset-4">
                   .                  
                    <div class="box">
                        <form name="form1" action="cadastro_obras.php" method="POST">
...
?>	
   ...
   @mysql_select_db($db);//selecione o banco de dados
           $sqltudo = mysql_query("SELECT * FROM crtl_patrimonio_obras ORDER BY id ")  or die(mysql_error());
