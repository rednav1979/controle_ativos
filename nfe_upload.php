...
$sql = mysql_query("update `crtl_patrimonio` set url_nfe='$nome_final' where id='$id'") or die(mysql_error());
} else {
...
?>
<br>
<a href="listar_pesquisa_nfe.php">Voltar</a>
