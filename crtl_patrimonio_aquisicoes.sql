...
--
-- Estrutura da tabela `crtl_patrimonio_aquisicoes`
--

CREATE TABLE `crtl_patrimonio_aquisicoes` (
  `id` int(11) NOT NULL,
...
--
-- Extraindo dados da tabela `crtl_patrimonio_aquisicoes`
--
...
--
-- Índices para tabela `crtl_patrimonio_aquisicoes`
--
ALTER TABLE `crtl_patrimonio_aquisicoes`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de tabela `crtl_patrimonio_aquisicoes`
--
ALTER TABLE `crtl_patrimonio_aquisicoes`
